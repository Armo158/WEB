...
<body>
    <?php
        ...
        if(!empty($bid)){# modify
            ...
            $filedetail = file_get_contents($tmpfile);
            $filedetail = addslashes($filedetail);

            $q = "INSERT INTO board(id, title, detail, file, filedetail, created) VALUES ('$id', '$title', '$detail', '$filename', '$filedetail', default)";
        }
